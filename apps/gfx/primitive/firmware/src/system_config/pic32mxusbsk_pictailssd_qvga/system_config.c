/*******************************************************************************
 GFX Primitive Demo Configuration file.
  ...
  Summary:
    Top-level configuration file for the GFX Primitive demo application for
    the pic32mxusbsk_pictailssd_qvga board configuration.

  Description:
    This file contains the GFX Primitive specific data that
