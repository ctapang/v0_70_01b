/*******************************************************************************
  ...
  Summary:
    Top-level configuration header for the GFX ObjectLayer Application.

  Description:
    This file is the top-level configuration header for the Object demo
    application which runs on the PIC32 Pictail SSD1926 board.
*******************************************************************************/
