/*******************************************************************************
  ...
  Summary:
    Top-level configuration header for the GFX SSD1926 Application.

  Description:
    This file is the top-level configuration header for the SSD1926 driver demo
    application which runs on the PIC32 SSD1926 board.
*******************************************************************************/
