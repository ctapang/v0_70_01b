...
void APP_Initialize( void )
{
    ...
    SYS_PORTS_PinDirectionSelect( PORTS_ID_0, SYS_PORTS_DIRECTION_OUTPUT, PORT_CHANNEL_A, PORTS_BIT_POS_6 );
    SYS_PORTS_PinDirectionSelect( PORTS_ID_0, SYS_PORTS_DIRECTION_OUTPUT, PORT_CHANNEL_A, PORTS_BIT_POS_7 );
    SYS_PORTS_PinDirectionSelect( PORTS_ID_0, SYS_PORTS_DIRECTION_INPUT, PORT_CHANNEL_G, PORTS_BIT_POS_9 );

    /* Clear the LED PORT lines*/
    SYS_PORTS_PinClear(PORTS_ID_0,PORT_CHANNEL_A, PORTS_BIT_POS_6 );
    SYS_PORTS_PinClear(PORTS_ID_0,PORT_CHANNEL_A, PORTS_BIT_POS_7 );
...
void APP_Tasks( void )
{
    ...
    switch(appData.state)
    {
        ...
        case APP_STATE_EEPROM_VERIFY:
        {
            ...
            {
                /* Test failed*/
                SYS_PORTS_PinSet(PORTS_ID_0,PORT_CHANNEL_A, PORTS_BIT_POS_6 );
            }
            else
            {
                /* Test Passed*/
                SYS_PORTS_PinSet(PORTS_ID_0,PORT_CHANNEL_A, PORTS_BIT_POS_7 );
            }
