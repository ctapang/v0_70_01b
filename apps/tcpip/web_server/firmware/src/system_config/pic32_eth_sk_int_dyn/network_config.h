...
{
    {
        ...
        "0.0.0.0",              // secondDNS
        "full",                 // powerMode
        (TCPIP_NETWORK_CONFIG_DHCP_CLIENT_ON | TCPIP_NETWORK_CONFIG_IPV6_ADDRESS),                   // start up flags
        "fdfe:dcba:9876:0001:204:a3ff:aaaa:aaaa",   // static IPv6 address; only if TCPIP_NETWORK_CONFIG_IPV6_ADDRESS specified
        64,                                         // subnet prefix length; only if TCPIP_NETWORK_CONFIG_IPV6_ADDRESS specified;
                                                    // should probably always be 64 as requested by the RFC (0 means default value, 64)
        "fdfe:dcba:9876:0001::1",                   // default IPv6 gateway address; only if TCPIP_NETWORK_CONFIG_IPV6_ADDRESS specified
    },
};
#else
