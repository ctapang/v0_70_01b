...
${OBJECTDIR}/_ext/184712360/usb_device.o: ../../framework/usb/src/dynamic/usb_device.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/184712360 
	@${RM} ${OBJECTDIR}/_ext/184712360/usb_device.o.d 
	@${RM} ${OBJECTDIR}/_ext/184712360/usb_device.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/184712360/usb_device.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -O1 -DINLINE_API="static inline" -DINLINE="static inline" -DUSE_CRYPTO_HW -I"../../framework/system" -I"../../framework" -I"." -I"../../framework/usb" -MMD -MF "${OBJECTDIR}/_ext/184712360/usb_device.o.d" -o ${OBJECTDIR}/_ext/184712360/usb_device.o ../../framework/usb/src/dynamic/usb_device.c   
