...
#define DRV_USB_ENDPOINTS_NUMBER    4

#define DRV_USB_MAX_QUEUE_LENGTH    8
...
#define USB_DEVICE_MSGBUF_COUNT     14 // (2 * DRV_USB_MAX_QUEUE_LENGTH)

#define USB_DEVICE_EP0_BUFFER_SIZE  64
#define USB_DEVICE_EP1_BUF_SIZE  USB_DEVICE_EP0_BUFFER_SIZE
#define USB_DEVICE_EP1_TOTAL_BUF_SIZE   (USB_DEVICE_MSGBUF_COUNT * USB_DEVICE_EP1_BUF_SIZE)

#define USB_DEVICE_SEND_HOST_SIZE   15 // match buf size in driver-klondike.c in cgminer
#define USB_DEVICE_TX_TOTAL_SIZE    (USB_DEVICE_MSGBUF_COUNT * (USB_DEVICE_SEND_HOST_SIZE + 1))
...
#define SYS_TMR_MAX_PERIODIC_EVENTS 8
...
#define SYS_TMR_INTERRUPT_MODE 1
