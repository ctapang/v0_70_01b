...
void SYS_Initialize ( void * data )
{
   ...
   /*initialize gfx stack and drivers*/
   GFX_Initialize();
   ...
   errStatus = xTaskCreate((pdTASK_CODE) SystemUSBDeviceTask,
                ...
                SYSTEM_USBDEVICETASK_STKSIZE,
                NULL,
                SYSTEM_USBDEVICETASK_PRIO,
                NULL);
                
   xTaskCreate((pdTASK_CODE) SystemDisplayDriverTask,
                (const signed char*)"Display Driver Task",
                SYSTEMDISPLAYDRIVERTASK_STKSIZE,
                NULL,
                SYSTEMDISPLAYDRIVERTASK_PRIO,
                NULL);
}