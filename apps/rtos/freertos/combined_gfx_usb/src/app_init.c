...
*
* Description : This function is called by the ApplicationUSBDeviceTask when the device is de-configured. 
*               It resets the application state in anticipation for the next device configured event
* Arguments   : 
*********************************************************************************************************
*/
