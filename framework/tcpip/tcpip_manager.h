/*******************************************************************************
  ...
  Description:
    TCP is a standard transport layer protocol described in RFC 793. It provides 
    reliable stream-based connections over unreliable networks, and forms the 
    foundation for HTTP, SMTP, and many other protocol standards.
*******************************************************************************/
//DOM-IGNORE-BEGIN
/*******************************************************************************
 ...
 *
 *
 * Note:            Currently only the MAC modules implement this function.
 ********************************************************************/
...
/************************************************************************************************************************
  ...
  Return:
    true if success false if no such interface
  Side Effects:
    None
  Example:
