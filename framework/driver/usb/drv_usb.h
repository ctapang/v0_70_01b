...
// *****************************************************************************
// *****************************************************************************
// Section: Inclusion of plib based on the architecture
// *****************************************************************************
// *****************************************************************************
...
/********************************************************************************
  ...
  Conditions:
    None.
  Input:
    drvIndex -  Ordinal number of driver instance to be initialized<p />
    init -      Pointer to a data structure containing any data necessary to
                initialize the driver. This should be a DRV_USB_INIT
                structure reference typecasted to SYS_MODULE_INIT reference.
  Return:
...
void DRV_USB_Tasks(SYS_MODULE_OBJ mobject);
...
/***********************************************************************************
  ...
  Description:
    ...
    of the IRP should not be changed till the IRP has been processed.
...
void DRV_USB_HOST_BusResetControl(DRV_HANDLE client, bool bcontrol);
void DRV_USB_HOST_StartOfFrameControl(DRV_HANDLE client, bool bcontrol);
