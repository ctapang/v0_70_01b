...
/* Function:
  ...
  Summary:
	Contruct the Public Key from a DER certificate.
...
/* Function:
  ...
  Summary:
	Contruct the Private Key from a DER certificate.
...
/* Function:
  ...
  Description:
	This function initializes the context used for Elliptic Curve Crypography (ECC).
...
/* Function:
  ...
  Precondition:
	...
	A random number geneator must all have been initialized with a call to CRYPT_RNG_Initialize.
  ...
  Parameters:
    ...
    usedSz	- Return value indcating how many bytes were used.
