...
/*********************************************************************************************************
  ...
  Description:
    ...
    GFX_GOL_SCROLLBAR_ACTION_INC    Touch      EVENT_PRESS,    If events occurs and the x,y position
                                     Screen     EVENT_MOVE      falls in the area of the slider and the
                                                                slider position is to the LEFT of the x,y
                                                                position for a horizontal slider or BELOW
                                                                the x,y position for a vertical slider.
    \                               Keyboard   EVENT_KEYSCAN   If event occurs and parameter1 passed
                                                                ...
                                                                SCAN_LEFT_PRESSED.
    GFX_GOL_SCROLLBAR_ACTION_DEC    Touch      EVENT_PRESS,    If events occurs and the x,y position
                                     Screen     EVENT_MOVE      falls in the area of the slider and the
                                                                slider position is to the RIGHT of the x,y
                                                                position for a horizontal slider or ABOVE
                                                                the x,y position for a vertical slider.
    \                               Keyboard   EVENT_KEYSCAN   If event occurs and parameter1 passed
                                                                matches the object's ID and parameter 2
                                                                passed matches SCAN_DOWN_PRESSED or
                                                                SCAN_RIGHT_PRESSED.
    GFX_GOL_OBJECT_ACTION_PASSIVE   Touch      EVENT_RELEASE   If events occurs and the x,y position
                                     Screen                     falls in the area of the slider.
