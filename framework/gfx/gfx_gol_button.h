...
/***************************************************************************
  ...
  Description:
    ...
    The object allows setting two images. One for the pressed state and the
    other for the release state. If no image is to be used for the object
    set both pointers to NULL.
    
    If only one image is used for both pressed and released state, set both
    pPressImage and pReleaseImage to the same image.
    
    The behavior of GFX_GOL_ButtonCreate() will be undefined if one of the
    following is true:
      * left \>= right
      * top \>= bottom
      * pScheme is not pointing to a GFX_GOL_OBJ_SCHEME
      * pPressImage and pReleaseImage is not pointing to a
        GFX_RESOURCE_HDR.
  ...
  Input:
    ...
    radius -         Radius of the rounded edge. When using gradient buttons
                     and radius != 0, emboss size \<= radius. If this is not
                     met, the GFX_GOL_BUTTON face will not have gradient
                     effect.
...
/**********************************************************************************************************
  ...
  Description:
    ...
    GFX_GOL_BUTTON_ACTION_PRESSED        Touch      EVENT_PRESS,       If events occurs and the x,y
                                          Screen     EVENT_MOVE         position falls in the face of the
    ...
    \                                    Keyboard   EVENT_KEYSCAN      If event occurs and parameter1
                                                                        ...
                                                                        GFX_GOL_BUTTON is not pressed.
    GFX_GOL_BUTTON_ACTION_STILLPRESSED   Touch      EVENT_STILLPRESS   If event occurs and the x,y
                                          Screen                        position does not change from the
                                                                        previous press position in the face
                                                                        of the GFX_GOL_BUTTON.
    GFX_GOL_BUTTON_ACTION_RELEASED       Touch      EVENT_RELEASE      If the event occurs and the x,y
                                          Screen                        position falls in the face of the
                                                                        GFX_GOL_BUTTON while the
    ...
    \                                    Keyboard   EVENT_KEYSCAN      If event occurs and parameter1
                                                                        ...
                                                                        parameter 2 passed matches
                                                                        SCAN_CR_RELEASED or
                                                                        SCAN_SPACE_RELEASED while the
                                                                        GFX_GOL_BUTTON is pressed.
    GFX_GOL_BUTTON_ACTION_CANCELPRESS    Touch      EVENT_MOVE         If the event occurs outside the
                                          Screen                        face of the GFX_GOL_BUTTON and the
  ...
  Return:
      ...
      * GFX_GOL_BUTTON_ACTION_CANCELPRESS – Object will be released, user
        cancels press action on the GFX_GOL_BUTTON
