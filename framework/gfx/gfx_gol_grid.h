...
/****************************************************************************
  Function:
     GridClearCellState(GRID *pGrid, short column, short row, uint16_t state)
    
  Description:
    This function clears the state of the cell (or Grid Item) specified by
    the column and row.
  Conditions:
    none
  Input:
    ...
    state -   specifies the state to be cleared. See Grid Item State.
  Return:
    none.
  Side Effects:
    none                                                                     
