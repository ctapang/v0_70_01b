...
/**********************************************************************************************************
  ...
  Description:
    ...
    Translated Message                   \Input     Set/Clear       \Description
                                          Source     State Bit       
    GFX_GOL_LISTBOX_ACTION_TOUCHSCREEN   Touch      Any             Item is selected using touch
                                          Screen                     screen.
    GFX_GOL_LISTBOX_ACTION_MOVE          Keyboard   EVENT_KEYSCAN   Focus is moved to the next
  ...
  Return:
      * GFX_GOL_LISTBOX_ACTION_TOUCHSCREEN – Item is selected using touch
        screen
      * GFX_GOL_LISTBOX_ACTION_MOVE – Focus is moved to the next item
        depending on the key pressed (UP or DOWN key).
...
/***********************************************************************************************
  ...
  Description:
    ...
    Translated                           \Input     Set/Clear State Bit Description
     Message                              Source     
    GFX_GOL_LISTBOX_ACTION_TOUCHSCREEN   Touch      Set GFX_GOL_LISTBOX_FOCUSED_STATE, If focus
                                          Screen     is enabled, the focus state bit
                                                     GFX_GOL_LISTBOX_FOCUSED_STATE will be set.
    \                                               Set GFX_GOL_LISTBOX_DRAW_FOCUS_STATE
                                                     GFX_GOL_LISTBOX_DRAW_FOCUS_STATE draw state
                                                     bit will force the List Box to be redrawn
                                                     with focus.
    \                                               Set GFX_GOL_LISTBOX_DRAW_ITEMS_STATE List
                                                     Box will be redrawn with selected item(s).
    GFX_GOL_LISTBOX_ACTION_MOVE          Keyboard   Set GFX_GOL_LISTBOX_DRAW_ITEMS_STATE List
                                                     Box will be redrawn with focus on one item.
    GFX_GOL_LISTBOX_ACTION_SELECTED      Keyboard   Set GFX_GOL_LISTBOX_DRAW_ITEMS_STATE List
                                                     Box will be redrawn with selection on the
