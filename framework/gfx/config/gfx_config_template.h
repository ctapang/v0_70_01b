...
/*************************************************************************
  Description:
    Similar to Font data bitmaps can also be placed in two locations. One
    is in FLASH memory and the other is from external memory. Defining one
    or both enables the support for bitmaps located in internal Flash and
    external memory. Define this in GraphicsConfig.h
      * USE_BITMAP_FLASH - Images located in internal flash memory.
      * USE_BITMAP_EXTERNAL - Images located in external memory
      * USE_BITMAP_FLASH &#45; Images located in internal Flash memory.
      * USE_BITMAP_EXTERNAL &#45; Images located in external memory
        (including external memory mapped to EDS)..
