/*******************************************************************************
 ...
 Description:
    ...
    application running on this combination of MEB2 board with the
    WVGA display panel.
*******************************************************************************/
...
#ifndef WVGA_BSP_CONFIG_H
#define WVGA_BSP_CONFIG_H
